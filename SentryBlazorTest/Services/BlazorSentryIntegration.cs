...
namespace SentryBlazorTest.Services;
...
public class BlazorSentryIntegration : IHostedService, IDisposable
{
    ...
    public BlazorSentryIntegration(IHub sentryHub, ILogger<BlazorSentryIntegration> logger)
    {
        ...
        {
            ShouldListenTo = source => source.Name == "Microsoft.AspNetCore.Components" ||
                                       source.Name == "Microsoft.AspNetCore.Components.Server.Circuits",
    ...
    {
        // Debug logging while I'm testing stuff :)
